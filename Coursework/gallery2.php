<?php include_once("header_template.php");?>
	...
	<div class="clear">
		...
		<article>
			...
			<p> 
			<a href="gallery.php"><img src="images/Palimpsest-002L.png" alt="Red blue and white windswept abstract" title="Palimpsest #2" class="galleryl"/> 
			</a>
			<h4> Title: Palimpsest #2</h4><br>
