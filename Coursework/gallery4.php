<?php include_once("header_template.php");?>
	...
	<div class="clear">
		...
		<article>
			...
			<p> 
			<a href="gallery.php"><img src="images/Palimpsest-004L.png" alt="Reds and blues with hints of gold angular brush strokes" title="Palimpsest #4" class="galleryl"/> 
			</a>
			<h4> Title: Palimpsest #4</h4><br>
