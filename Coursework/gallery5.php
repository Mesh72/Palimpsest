<?php include_once("header_template.php");?>
	...
	<div class="clear">
		...
		<article>
			...
			<p> 
			<a href="gallery.php"><img src="images/Palimpsest-005L.png" alt="Dark reds cover a majority of mixed blues intersectioned with a white mist" title="Palimpsest #5" class="galleryl"/> 
			</a>
			<h4> Title: Palimpsest #5</h4><br>
