<?php include_once("header_template.php");?>
	...
	<div class="clear">
		...
		<article>
			...
			<p> 
			<a href="gallery.php"><img src="images/Palimpsest-006L.png" alt="Gold base with blue red and white angular marks" title="Palimpsest #6" class="galleryl"/> 
			</a>
			<h4> Title: Palimpsest #6</h4><br>
