<?php include_once("header_template.php");?>
	...
	<div class="clear">
		...
		<article>
			...
			<p> 
			<a href="gallery.php"><img src="images/Palimpsest-008L.png" alt="Blue hues fill most of this canvas with interruptions of green and white" title="Palimpsest #8" class="galleryl"/> 
			</a>
			<h4> Title: Palimpsest #8</h4><br>
