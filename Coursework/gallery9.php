<?php include_once("header_template.php");?>
	...
	<div class="clear">
		...
		<article>
			...
			<p> 
			<a href="gallery.php"><img src="images/Palimpsest-009L.png" alt="Self portrait of the palimpsest paintings artist" title="Palimpsest #9" class="galleryl"/> 
			</a>
			<h4> Title: Palimpsest #9</h4><br>
